...
const Home = ({expenseCount,expensesTotal,expensesMonthlyTotal,expensesYearlyTotal,displayName,url}) => {
    ...
    const generateGreetings = ()=>{
        const time = moment(now()).format('HH');
        if(time>=0 && time<4){
            return "Hello ! 🦉";
        }
    ...
    return (
        <div class="flex flex-col w-full h-full p-7">
            ...
            <div class="overflow-auto">
                ...
                {/* NOTICE */}
                <div class="bg-orange-200 px-6 py-4 my-4 rounded-md text-sm flex items-center w-3/4 xl:w-2/4 bg-white">
                <svg
                    viewBox="0 0 24 24"
                ...
                <span class="text-yellow-800">
                    Comming soon ! Expenses Analytics is under development please ignore this section.
                </span>
                </div>
